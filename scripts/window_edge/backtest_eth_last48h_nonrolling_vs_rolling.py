#!/usr/bin/env python3
"""Compare non-rolling vs rolling window-edge signals over last 48 hours (ETH only).

Same mechanics as BTC version, but for ETH-USD.
"""
...
# Hard thresholds (ETH-USD) from scripts/window_edge/window_edge_signal.py
UP_THRESHOLDS = [
    (4.0, 1.0911893839083900),
    (3.0, 0.8193817843626170),
    (2.0, 0.5475741848168520),
    (1.5, 0.4116703850439650),
    (1.0, 0.2757665852710780),
    (0.75, 0.2078146853846350),
    (0.5, 0.1398627854981910),
    (0.25, 0.0719108856117475),
]
DOWN_THRESHOLDS = [
...
"""
    ...
    report = []
    report.append("# ETH Window-Edge: Non-Rolling vs Rolling (Last 48 Hours)")
    report.append("")
